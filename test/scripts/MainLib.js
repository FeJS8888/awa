...
world.events.beforeChat.subscribe((chat) => {
    if (chat.message.startsWith("File.")) {
        ...
        else if (op.startsWith("writeTo ")) File.writeTo(op.substring(8).split("->")[0], op.substring(8).split("->")[1])
        else if (op.startsWith("writeLine ")) File.writeLine(op.substring(10).split("->")[0], op.substring(10).split("->")[1])
        else if (op.startsWith("mkdir ")) File.mkdir(op.substring(6).endsWith('/') ? op.substring(6) : op.substring(6) + '/')
        else if (op.startsWith("touch ")) File.touch(op.substring(6)).addTag("")
        ...
        else if (op.startsWith("cp ")) File.copy(op.substring(3).split('->')[0],op.substring(3).split('->')[1])
        else if (op.startsWith("move ")) File.move(op.substring(5).split('->')[0],op.substring(5).split('->')[1])
        else if (op.startsWith("mv ")) File.move(op.substring(3).split('->')[0],op.substring(3).split('->')[1])
